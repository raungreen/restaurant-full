                                        ...
                                        <div class="table-responsive">
                                            <table class="table">
                                                ...
                                                @foreach ($latestReservations as $reservation )
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <span class="badge-dot badge-success mr-1"></span>Booth / Table
                                                            @else  
                                                ...
                                                @endforeach
                                                    <tr>
                                                        <td colspan="9">
                                                            <a href="/admin/reservations" class="btn btn-outline-light float-right">View More</a>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
