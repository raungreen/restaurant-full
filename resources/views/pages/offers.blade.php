      ...
      <div class="content-box">
        <div class="row">
          <div class="col-md-8 offset-md-2">
            <h1>Sign Up To Receive Notificatons for Deals</h1>
            <form method="POST" action="/offers">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input id="inputemail" type="email" class="form-control form-control-lg @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="name@example.com">
              ...
              <div class="row">
                    <div class="col-md-6">
                      <div class='form-group'>
                        <p>
                          In signing up I acknowledge that I am 18 years or older, want to receive email offers from Billy's Burger and, if I select to join Dine Rewards, agree to the terms and condition of the program.
                        </p>
                      </div>
                    </div>
                    <div class="col-md-6">
